...
test_data = pd.read_csv('/home/sshamsi/Projects/astrobio_tutorials/t3_exoplanets_ml/exoTest.csv').fillna(0)
train_data = pd.read_csv('/home/sshamsi/Projects/astrobio_tutorials/t3_exoplanets_ml/exoTrain.csv').fillna(0)
